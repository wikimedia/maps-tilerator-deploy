...
Tile.Value._readField = function (tag, obj, pbf) {
    ...
    switch (tag) {
        case 1: obj._String = pbf.readString(); break;
        case 2: obj._Float = pbf.readFloat(); break;
        case 3: obj._Double = pbf.readDouble(); break;
        case 4: obj._Varint = pbf.readVarint(true); break;
        case 5: obj._Varint = pbf.readVarint(); break;
        case 6: obj._SVarint = pbf.readSVarint(); break;
        case 7: obj._Boolean = pbf.readBoolean(); break;
...
Tile.Value.write = function (obj, pbf) {
    switch (obj.tag){
        case 1: pbf.writeStringField(1, obj._String); break;
        case 2: pbf.writeFloatField(2, obj._Float); break;
        case 3: pbf.writeDoubleField(3, obj._Double); break;
        case 4: pbf.writeVarintField(4, obj._Varint); break;
        case 5: pbf.writeVarintField(5, obj._Varint); break;
        case 6: pbf.writeSVarintField(6, obj._SVarint); break;
        case 7: pbf.writeBooleanField(7, obj._Boolean); break;
