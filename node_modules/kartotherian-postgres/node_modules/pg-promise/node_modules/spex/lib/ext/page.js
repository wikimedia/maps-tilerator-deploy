 ...
 *
 * And if the function resolves with anything other than an array or `undefined`, the method
 * rejects with the same object, but with `error` = `Unexpected data returned from the source.`
 *
 * Passing in anything other than a function will throw `Invalid page source.`
 *
 * @param {function} [dest]
 * Optional destination function (notification callback), to receive a resolved $[batch] of data
 ...
 *
 * Passing in a non-empty value other than a function will throw `Invalid page destination.`
 *
 * @param {Number} [limit=0]
 * Limits the maximum number of pages to be requested from the `source`. If the value is an
